...
*/
 ...
 experience["One"]=0.802;
 experience["Two"]=0.94;
 experience["Three"]=0.895;
 experience["Four"]=0.88;
 experience["Five"]=0.87;
...
{  
    ...
    var theForm = document.forms["insuranceForm"];
    //Get a reference to the cake the user Chooses name=selectedCake":
    var selectedCake = theForm.elements["selectedAge"];
    ...
    for(var i = 0; i < selectedAge.length; i++)
    {
        ...
        if(selectedAge[i].checked)
        {
            ...
            agePricing = ages[selectedAge[i].value];
